...
import { CheckCircle, ArrowRight, Phone, Star, Award, Plane } from "lucide-react"

export const metadata: Metadata = {
  title: "Expert Carpenter Kempton Park | Kitchen Renovations & Joinery Services",
  description:
    "Expert carpenter in Kempton Park near OR Tambo Airport. Professional kitchen renovations, built-in cupboards, granite installation for Kempton Park, Edenvale, Bedfordview. Quality carpentry services.",
  keywords:
    "carpenter Kempton Park, kitchen renovation Kempton Park, built-in cupboards Kempton Park, granite installation Kempton Park, carpenter Edenvale, kitchen cabinets Bedfordview, joinery Kempton Park, professional carpenter OR Tambo, custom carpentry Kempton Park",
}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <div className="flex items-center mb-4">
                ...
                <span className="text-slate-600 font-medium text-sm sm:text-base">Expert Kempton Park Carpenter</span>
              </div>
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-800 mb-4 sm:mb-6 leading-tight">
                ...
                <span className="text-amber-600">Kempton Park</span>
              </h1>

              <p className="text-lg sm:text-xl text-slate-600 mb-6 sm:mb-8 leading-relaxed">
                Professional carpentry and joinery services in Kempton Park, Edenvale, and Bedfordview. Expert kitchen
                renovations, custom built-in cupboards, and granite installations near OR Tambo Airport area.
              </p>
              ...
              <div className="flex items-center space-x-4 text-slate-600 text-sm sm:text-base">
                <div className="flex items-center">
                  <Plane className="w-4 h-4 sm:w-5 sm:h-5 text-amber-600 mr-2" />
                  <span>Near OR Tambo</span>
                </div>
                <div className="flex items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 sm:-bottom-6 sm:-left-6 bg-white p-3 sm:p-4 rounded-lg shadow-lg">
                ...
                <div className="text-slate-600 text-sm sm:text-base">Joinery</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-800 mb-4">
              Serving All Kempton Park Areas
            </h2>
            <p className="text-lg sm:text-xl text-slate-600">
              Expert carpentry services throughout Kempton Park and East Rand areas
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6 sm:p-8">
                <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-4">Professional Joinery</h3>
                <p className="text-slate-600 mb-4 text-sm sm:text-base">
                  Expert joinery services for Kempton Park homes. Custom woodwork and precision craftsmanship for all
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6 sm:p-8">
                <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-4">Custom Built-ins</h3>
                <p className="text-slate-600 mb-4 text-sm sm:text-base">
                  Specialized built-in storage solutions for Kempton Park properties. Maximize space with expert
                  craftsmanship.
                </p>
                <ul className="space-y-2 text-slate-600 mb-6 text-sm sm:text-base">
                  <li className="flex items-center">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-amber-600 to-amber-700 text-white">
        <div className="container mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6">
            Ready for Expert Kempton Park Service?
          </h2>
          <p className="text-lg sm:text-xl mb-6 sm:mb-8 opacity-90 max-w-2xl mx-auto">
            Contact Kempton Park's expert carpentry specialists today. Professional joinery, quality craftsmanship, and
            reliable service for your home improvement projects.
          </p>
