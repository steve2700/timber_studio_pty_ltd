...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Expert Granite Installers Centurion | Professional Installation Services",
    description:
      "Professional granite installers in Centurion. Expert countertop installation, supply & fitting. Serving all Centurion suburbs. Free quotes.",
    url: "https://granitecarpentry.co.za/granite-installers-centurion",
    siteName: "Granite Carpentry",
    locale: "en_ZA",
    type: "website",
  },
  alternates: {
    canonical: "https://granitecarpentry.co.za/granite-installers-centurion",
  },
}

export default function GraniteInstallersCenturionPage() {
  const services = [
    {
    ...
    },
    {
      ...
      description: "Serving Centurion's business community with restaurant, office, and retail installations",
      features: ["Reception desks", "Restaurant counters", "Retail displays", "Corporate kitchens"],
    },
  ]

  const suburbs = [
    { name: "Irene", description: "Family-friendly estates and farms" },
    { name: "Highveld", description: "Established residential area" },
    { name: "The Reeds", description: "Security estates and golf living" },
    { name: "Lyttelton", description: "Lyttelton Manor and extensions" },
    { name: "Centurion CBD", description: "Modern apartments and commercial" },
    { name: "Eldoraigne", description: "Suburban family homes" },
  ]
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
              Expert Granite Installers Serving Centurion & Surrounds
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto">
              Professional granite installation in Centurion, Irene, Highveld, The Reeds & surrounding areas. Over 20
              years of experience delivering premium countertop installations.
            </p>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="prose prose-lg max-w-none">
            <p className="text-lg leading-relaxed">
              Looking for trusted granite installers in Centurion? Granite Carpentry is Centurion's premier granite
              installation specialist, serving homeowners and businesses throughout Centurion, Irene, Highveld, The
              Reeds, and surrounding areas. With over 20 years of experience installing granite countertops in Centurion
              homes, we're the local granite installation experts you can trust for quality workmanship, professional
              service, and stunning results.
            </p>
            <p className="text-lg leading-relaxed mt-4">
              Our certified granite installers specialize in precision countertop installation for Centurion
              properties—from golf estates in The Reeds to modern apartments in Centurion CBD, family homes in Irene to
              established properties in Highveld. We understand Centurion's high standards and deliver granite
      ...
      <section className="py-16 px-4 md:px-6 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
            Granite Installation Services in Centurion
          </h2>
      ...
      <section className="py-16 px-4 md:px-6">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">Centurion Suburbs We Serve</h2>
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            Professional granite installation services throughout all Centurion suburbs and neighboring areas
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Hundreds of successful Centurion installations</CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Quick response times to Centurion properties</CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Standards matching Centurion's prestige</CardDescription>
              </CardHeader>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="space-y-8">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2">Free Centurion Consultation</h3>
                <p className="text-muted-foreground">
                  We visit your property to discuss requirements, assess space, show samples, and provide detailed
                  quotes. Convenient scheduling for busy Centurion residents.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Visit our showroom or we bring samples to your Centurion home. Choose granite type, color, and finish
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  integrate appliances, apply sealer, and complete thorough cleanup. Most Centurion installations
      ...
      <section className="py-16 px-4 md:px-6 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
            Transparent Pricing for Centurion Projects
          </h2>
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          ...
          <div className="bg-background p-8 rounded-lg border">
            <h3 className="text-2xl font-bold mb-6">Typical Centurion Kitchen Projects</h3>
      ...
      <section className="py-16 px-4 md:px-6">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
            Popular Granite Choices for Centurion Homes
          </h2>
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            Trending granite options for contemporary and luxury Centurion properties
          </p>
          <div className="grid md:grid-cols-2 gap-8">
            <Card>
              <CardHeader>
                <CardTitle>Contemporary Centurion Kitchens</CardTitle>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Luxury Centurion Installations</CardTitle>
                <CardDescription>Premium exotic options</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
                  <li>
                    <strong>Blue Pearl:</strong> Unique, statement-making for golf estates
                  </li>
                  <li>
      ...
      <section className="py-16 px-4 md:px-6 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
            Working in Centurion Estates & Security Complexes
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <Card>
              <CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Golf Estate Installations</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                    <span>Experience with Centurion golf estate properties</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                    <span>Understanding of estate construction standards</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                    <span>Coordination with estate management</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                    <span>Respect for estate architectural guidelines</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
      ...
      <section className="py-16 px-4 md:px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Do you service all Centurion suburbs?</CardTitle>
              </CardHeader>
              <CardContent>
                <p>
                  Yes! We serve all of Centurion including Irene, Highveld, The Reeds, Lyttelton, Eldoraigne, and
                  surrounding areas with quick response times.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
                <CardTitle>Can you work in security estates and golf estates?</CardTitle>
              </CardHeader>
              <CardContent>
                <p>
                  Absolutely. We're experienced with Centurion estates including golf estates and understand all
            ...
            <Card>
              <CardHeader>
                <CardTitle>How quickly can you complete a Centurion installation?</CardTitle>
              </CardHeader>
              <CardContent>
                <p>
            ...
            <Card>
              <CardHeader>
                <CardTitle>What granite is most popular in Centurion?</CardTitle>
              </CardHeader>
              <CardContent>
                <p>
                  Currently, white granites (Kashmir White, Colonial White) and black granites (Absolute Black, Steel
                  Grey) are trending in Centurion's contemporary homes. For luxury properties, Blue Pearl and Emerald
      ...
      <section id="contact" className="py-16 px-4 md:px-6 bg-primary text-primary-foreground">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Contact Your Centurion Granite Installers</h2>
          <p className="text-xl mb-8 opacity-90">
            Ready to transform your Centurion property with beautiful granite countertops?
          </p>
          ...
          <Button size="lg" variant="secondary" asChild className="text-lg px-8">
            <a href="tel:0676014490">Get Your Free Centurion Installation Quote</a>
          </Button>
        </div>
      </section>
    </div>
