...
export const metadata: Metadata = {
  title: "★★★★★ Expert Granite Installers Pretoria 2025 | #1 Professional Installation",
  description:
    "★★★★★ #1 professional granite installers in Pretoria. Expert countertop installation, supply & fitting. Serving all Pretoria suburbs. Free quotes. Call 067 601 4490!",
  openGraph: {
    title: "Expert Granite Installers Pretoria | Professional Installation Services",
    description:
      "Professional granite installers in Pretoria. Expert countertop installation, supply & fitting. Serving all Pretoria suburbs. Free quotes.",
    url: "https://granitecarpentry.co.za/granite-installers-pretoria",
    siteName: "Granite Carpentry",
    locale: "en_ZA",
    type: "website",
  },
  alternates: {
    canonical: "https://granitecarpentry.co.za/granite-installers-pretoria",
  },
}

export default function GraniteInstallersPretoriaPage() {
  const services = [
    {
    ...
    },
    {
      ...
      description: "Serving Pretoria's business community with restaurant, office, and retail installations",
      features: ["Reception desks", "Restaurant counters", "Retail displays", "Corporate kitchens"],
    },
  ]

  const suburbs = [
    { name: "Pretoria East", description: "Silver Lakes, Faerie Glen, Garsfontein" },
    { name: "Waterkloof", description: "Luxury estates and heritage properties" },
    { name: "Menlyn", description: "Modern apartments and townhouses" },
    { name: "Lynnwood", description: "Established residential suburbs" },
    { name: "Brooklyn", description: "Diplomatic and embassy area" },
    { name: "Hatfield", description: "Student and professional accommodation" },
  ]
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
              Expert Granite Installers Serving Pretoria & Surrounds
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto">
              Professional granite installation in Pretoria, Centurion, Pretoria East, Waterkloof & surrounding capital
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="prose prose-lg max-w-none">
            <p className="text-lg leading-relaxed">
              Looking for trusted granite installers in Pretoria? Granite Carpentry is Pretoria's premier granite
              installation specialist, serving homeowners and businesses throughout Pretoria, Centurion, Pretoria East,
              Waterkloof, and surrounding capital suburbs. With over 20 years of experience installing granite
              countertops in Pretoria homes, we're the local granite installation experts you can trust for quality
              workmanship, professional service, and stunning results.
            </p>
            <p className="text-lg leading-relaxed mt-4">
              Our certified granite installers specialize in precision countertop installation for Pretoria
              properties—from luxury estates in Waterkloof to modern apartments in Menlyn, contemporary homes in
              Pretoria East to family residences in Lynnwood. We understand Pretoria's high standards and deliver
              granite installations that match the quality and sophistication expected in the capital city.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-6 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
            Granite Installation Services in Pretoria
          </h2>
      ...
      <section className="py-16 px-4 md:px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            Professional granite installation services throughout all Pretoria suburbs and neighboring areas
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Hundreds of successful Pretoria installations</CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Quick response times to Pretoria properties</CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Standards matching the capital's prestige</CardDescription>
              </CardHeader>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="space-y-8">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2">Free Pretoria Consultation</h3>
                <p className="text-muted-foreground">
                  We visit your property to discuss requirements, assess space, show samples, and provide detailed
                  quotes. Convenient scheduling for busy Pretoria residents.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Visit our showroom or we bring samples to your Pretoria home. Choose granite type, color, and finish
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  integrate appliances, apply sealer, and complete thorough cleanup. Most Pretoria installations
      ...
      <section className="py-16 px-4 md:px-6 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">Transparent Pricing for Pretoria Projects</h2>
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          ...
          <div className="bg-background p-8 rounded-lg border">
            <h3 className="text-2xl font-bold mb-6">Typical Pretoria Kitchen Projects</h3>
      ...
      <section className="py-16 px-4 md:px-6">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
            Popular Granite Choices for Pretoria Homes
          </h2>
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            Trending granite options for contemporary and luxury Pretoria properties
          </p>
          <div className="grid md:grid-cols-2 gap-8">
            <Card>
              <CardHeader>
                <CardTitle>Contemporary Pretoria Kitchens</CardTitle>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Luxury Pretoria Installations</CardTitle>
                <CardDescription>Premium exotic options</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
                  <li>
                    <strong>Blue Pearl:</strong> Unique, statement-making for Waterkloof estates
                  </li>
                  <li>
      ...
      <section className="py-16 px-4 md:px-6 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
            Working in Pretoria Estates & Security Complexes
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <Card>
              <CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Diplomatic & Embassy Areas</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                    <span>Experience with high-security diplomatic residences</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                    <span>Strict confidentiality and professionalism</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                    <span>Security vetting and background checks</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                    <span>Working with embassy protocols</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
      ...
      <section className="py-16 px-4 md:px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Do you service all Pretoria suburbs?</CardTitle>
              </CardHeader>
              <CardContent>
                <p>
                  Yes! We serve all of Pretoria including Pretoria East, Waterkloof, Menlyn, Lynnwood, Brooklyn,
                  Hatfield, and surrounding areas with quick response times.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
                <CardTitle>Can you work in security estates and diplomatic areas?</CardTitle>
              </CardHeader>
              <CardContent>
                <p>
                  Absolutely. We're experienced with Pretoria estates and understand all security protocols including
                  diplomatic and embassy residences. We'll coordinate with security for smooth access and minimal
                  disruption.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
                <CardTitle>How quickly can you complete a Pretoria installation?</CardTitle>
              </CardHeader>
              <CardContent>
                <p>
            ...
            <Card>
              <CardHeader>
                <CardTitle>What granite is most popular in Pretoria?</CardTitle>
              </CardHeader>
              <CardContent>
                <p>
                  Currently, white granites (Kashmir White, Colonial White) and black granites (Absolute Black, Steel
                  Grey) are trending in Pretoria's contemporary homes. For luxury properties, Blue Pearl and Emerald
      ...
      <section id="contact" className="py-16 px-4 md:px-6 bg-primary text-primary-foreground">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Contact Your Pretoria Granite Installers</h2>
          <p className="text-xl mb-8 opacity-90">
            Ready to transform your Pretoria property with beautiful granite countertops?
          </p>
          ...
          <Button size="lg" variant="secondary" asChild className="text-lg px-8">
            <a href="tel:0676014490">Get Your Free Pretoria Installation Quote</a>
          </Button>
        </div>
      </section>
    </div>
