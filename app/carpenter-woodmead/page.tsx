...
export const metadata: Metadata = {
  title: "Carpenter Woodmead 2026 | Kitchen Renovations & Built-in Cupboards | Same Day Quotes",
  description:
    "★★★★★ #1 Carpenter in Woodmead. Expert kitchen renovations, luxury built-in cupboards & granite installations. 50+ completed Woodmeadprojects. Licensed & insured. Call 067 601 4490",
  keywords:
    "carpenter Woodmead, kitchen renovation Woodmead, built-in cupboards Woodmead, granite installation Woodmead, carpenter near me Woodmead, Woodmeadcarpenter, kitchen cabinets Woodmead, cupboards Woodmead, best carpenter Woodmead",
  alternates: {
    canonical: "https://granitecarpentry.co.za/carpenter-woodmead",
  },
  openGraph: {
    title: "Carpenter Woodmead 2026 | Kitchen Renovations & Built-in Cupboards",
    description:
      "★★★★★ #1 Carpenter in Woodmead. Expert kitchen renovations, luxury built-in cupboards & granite installations. Call 067 601 4490",
    url: "https://granitecarpentry.co.za/carpenter-woodmead",
    images: [
      {
        url: "https://granitecarpentry.co.za/granite-installation-sandton.jpg",
        width: 1200,
        height: 630,
        alt: "Carpenter Woodmead- Kitchen Renovation & Built-in Cupboards",
      },
    ],
  },
}
...
const schemaMarkup = {
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "@id": "https://granitecarpentry.co.za/#carpenter-woodmead",
      "name": "Granite Carpentry - Woodmead Carpenter",
      "image": "https://granitecarpentry.co.za/granite-installation-sandton.jpg",
      "telephone": "+27676014490",
      "priceRange": "R400-R25000",
      "address": {
        "@type": "PostalAddress",
        "addressLocality": "Woodmead",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://granitecarpentry.co.za/#breadcrumb-woodmead",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
...
export default function CarpenterWoodmeadPage() {
  return (
    <>
      {/* Schema Markup */}
      <script
      ...
      <section className="bg-slate-50 py-4">
        <div className="container mx-auto">
          <nav className="flex items-center text-sm text-slate-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-900 font-medium">Carpenter Woodmead</span>
          </nav>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <div className="flex items-center mb-4">
                ...
                <Badge variant="secondary" className="bg-amber-600/20 text-amber-100 border-amber-300">
                  Woodmead's #1 Carpenter
                </Badge>
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                <span className="text-amber-400">Carpenter Woodmead</span>
                <br />
                Kitchen Renovations & Built-in Cupboards
              </h1>

              <p className="text-xl sm:text-2xl text-slate-200 mb-8 leading-relaxed">
                ★★★★★ Rated Woodmead's most trusted carpenter with 50+ completed local projects. Expert kitchen renovations, luxury built-in cupboards, granite installations & emergency plumbing for Woodmeadapartments, townhouses, and homes.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button size="lg" asChild className="bg-amber-600 hover:bg-amber-700 text-lg px-8 py-4 font-semibold">
                  <Link href="/contact">
                    Get FREE WoodmeadQuote
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 bg-amber-600 text-white p-4 rounded-lg shadow-lg">
                ...
                <div className="text-sm">Woodmead Projects</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Why Choose Local WoodmeadCarpenter */}
      <section className="py-16 bg-white">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 mb-4">
              Why Woodmead Residents Choose Us
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              We understand Woodmead's unique properties - from luxury apartments in The Woodmead Drive to townhouses near Maxwell Drive
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-800 mb-3">Local Woodmead Expertise</h3>
                <p className="text-slate-600">
                  We've completed 30+ projects in Woodmead- from The  Woodmead Estate to Woodmead Centre. We know local building requirements, body corporate rules, and parking access for materials delivery.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-slate-600">
                  Based nearby in Sandton, we're typically on-site in Woodmead within 30-45 minutes for quotes and emergency plumbing. Same-day quotes for kitchen and carpentry projects.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-slate-600">
                  Experienced in working within Woodmead's apartment complexes. We coordinate with building management, work within noise restrictions, and ensure clean, minimal disruption.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      {/* WoodmeadKitchen Renovation Section */}
      <section className="py-16 bg-gradient-to-br from-amber-50 to-slate-50">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 mb-4">
              Kitchen Renovation Woodmead- Apartment & Townhouse Specialists
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Transform your Woodmead kitchen with designs perfect for apartment living and modern townhouses. Space-efficient solutions with luxury finishes.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <Card className="hover:shadow-xl transition-shadow">
              <CardHeader>
                <CardTitle className="text-2xl">Woodmead Apartment Kitchens</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-slate-600 mb-4">
                  Specialized kitchen designs for Woodmead apartments like Woodmead Apartments precinct, Maxwell Drive, and Leeukop Road. Maximizing limited space with smart storage solutions.
                </p>
                <ul className="space-y-3 mb-6">
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-sm"><strong>Compact kitchen islands</strong> - Perfect for open-plan Woodmead apartments</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                ...
                <div className="bg-slate-100 p-4 rounded-lg">
                  <p className="text-sm font-semibold text-slate-800 mb-2">Woodmead Apartment Kitchens from R28,000</p>
                  <p className="text-xs text-slate-600">Completed projects in Maxwell Drive, Leeukop Road, Main Road Woodmead</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-xl transition-shadow border-2 border-amber-400">
              <CardHeader>
                <CardTitle className="text-2xl flex items-center">
                  ...
                  Woodmead Townhouse Kitchens
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-slate-600 mb-4">
                  Full kitchen renovations for Woodmead town houses and family homes. Contemporary designs with entertaining in mind.
                </p>
                <ul className="space-y-3 mb-6">
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-sm"><strong>Indoor-outdoor flow</strong> - Perfect for Woodmead's entertaining lifestyle</span>
                  </li>
                </ul>
                <div className="bg-amber-50 p-4 rounded-lg">
                  <p className="text-sm font-semibold text-slate-800 mb-2">Woodmead Townhouse Kitchens from R45,000</p>
          ...
          <div className="text-center">
            <Button size="lg" asChild className="bg-amber-600 hover:bg-amber-700">
              <Link href="/contact">Get Your Free Woodmead Kitchen Quote</Link>
            </Button>
      ...
      {/* Built-in Cupboards Woodmead*/}
      <section className="py-16 bg-white">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 mb-4">
              Built-in Cupboards Woodmead- Custom Storage Solutions
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Maximize your Woodmead property's storage with custom built-in cupboards designed for apartments and townhouses
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-slate-600 mb-4 text-sm">
                  Walk-in closets and built-in wardrobes perfect for Woodmead apartments and townhouses.
                </p>
            ...
            <Card className="hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-slate-600 mb-4 text-sm">
                  Custom home office solutions for Woodmead professionals working from home.
                </p>
                <ul className="space-y-2 mb-4">
                  <li className="flex items-center text-sm">
                    <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
            ...
            <Card className="hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-slate-600 mb-4 text-sm">
                  Sleek entertainment centers designed for modern Woodmead living spaces.
                </p>
                <ul className="space-y-2 mb-4">
                  <li className="flex items-center text-sm">
                    <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
      ...
      {/* WoodmeadCustomer Reviews */}
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 mb-4">
              What Woodmead Clients Say
            </h2>
            <p className="text-xl text-slate-600">
              ★★★★★ 5.0 Rating - 30+ verified reviews from Woodmead residents
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-slate-700 mb-4 italic">
                  "Outstanding craftsmanship on our apartment kitchen in The Zone. They worked around our building's noise restrictions and the final result is stunning. Highly recommend for Woodmeadapartments!"
                </p>
                <p className="font-semibold text-slate-800">James T.</p>
                <p className="text-sm text-slate-600">Woodmead Drive, Woodmead</p>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-slate-700 mb-4 italic">
                  "Best carpenter in Woodmead! Transformed our townhouse kitchen with a beautiful island and quartz countertops. Professional team, clean work, completed on schedule."
                </p>
                <p className="font-semibold text-slate-800">Sarah K.</p>
                <p className="text-sm text-slate-600">Woodmead Gardens, Woodmead</p>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-slate-700 mb-4 italic">
                  "Excellent built-in cupboards for our Woodmead apartment. Maximized every inch of space with clever storage solutions. The quality is exceptional and the team was a pleasure to work with."
                </p>
                <p className="font-semibold text-slate-800">Michael R.</p>
                <p className="text-sm text-slate-600">44 Stanley, Woodmead</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 mb-4">
              Frequently Asked Questions - Carpenter Woodmead
            </h2>
          </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center text-lg">
                  <MessageCircle className="w-5 h-5 text-amber-600 mr-2" />
                  Do you work with Woodmead body corporates and building management?
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-slate-700 text-sm">
                  Yes! We have extensive experience working in Woodmead places  like Woodmead North, Woodmead Central and  Buccleuch (border). We handle all body corporate communications, submit required documentation, coordinate materials delivery and parking, work within noise restriction hours (typically 8am-5pm weekdays), and ensure minimal disruption to neighbors. We're familiar with access procedures and building requirements.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center text-lg">
                  <MessageCircle className="w-5 h-5 text-amber-600 mr-2" />
                  Do you offer same-day quotes in Woodmead?
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-slate-700 text-sm">
                  Yes! Based nearby in Sandton, we can typically reach Woodmead properties within 30-45 minutes. Call us at 067 601 4490 before 2pm and we can often visit your Woodmead property the same day. We provide detailed written quotes within 24 hours covering materials, labor, and timeline. Emergency plumbing quotes are provided immediately upon arrival.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center text-lg">
                  <MessageCircle className="w-5 h-5 text-amber-600 mr-2" />
                  What areas near Woodmead do you also serve?
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-slate-700 text-sm">
                  Beyond Woodmead, we serve all nearby Sandton suburbs including Hyde Park, Illovo, Melrose, Parktown North, Saxonwold, Dunkeld,MorningSide and Parkwood. We also cover the broader Sandton area including Woodmead, Woodmead, and Woodmead. For our complete service area, visit our <Link href="/areas/sandton" className="text-amber-600 hover:underline">Sandton areas page</Link>.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center text-lg">
                  <MessageCircle className="w-5 h-5 text-amber-600 mr-2" />
                  Can you install granite countertops in Woodmead apartments?
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-slate-700 text-sm">
                  Absolutely! We specialize in granite and quartz installations for Woodmead properties. We coordinate lift access for materials, protect common areas during transport, and complete templating and installation efficiently. Popular choices for Woodmeadapartments include Caesar Stone, Silestone, and premium granite varieties. Prices start from R8,500 for standard countertops. Learn more about our <Link href="/quartz-granite" className="text-amber-600 hover:underline">granite and quartz services</Link>.
                </p>
              </CardContent>
            </Card>
      ...
      {/* WoodmeadService Areas Map */}
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 mb-4">
              Serving All Woodmead Areas
            </h2>
            <p className="text-xl text-slate-600">
              From The Mutual Road to Woodmead Road  complete coverage across Woodmead
            </p>
          </div>
          ...
          <div className="text-center mt-8">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link href="/carpenter-sunninghill" className="text-amber-600 hover:underline font-semibold">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 mb-4">
              Our Woodmead Carpentry & Plumbing Services
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-slate-600 mb-3">
                  Complete kitchen transformations for Woodmead apartments and townhouses.
                </p>
            ...
            <Card className="hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-slate-600 mb-3">
                  24/7 emergency plumbing services throughout Woodmead.
                </p>
      ...
      <section className="py-16 bg-gradient-to-r from-amber-600 to-amber-700 text-white">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">Ready to Transform Your Woodmead Property?</h2>
          <p className="text-xl mb-8 opacity-90 max-w-3xl mx-auto">
            Join 50+ satisfied Woodmead clients. Get your FREE quote today from Woodmead's most trusted carpenter. Licensed, insured, and experienced in apartment buildings and townhouses.
          </p>
          ...
          <div className="mt-8 text-center">
            <p className="text-lg opacity-90">
              ⭐⭐⭐⭐⭐ "Outstanding craftsmanship on our apartment kitchen in Woodmead North!" - James T., Woodmead
            </p>
          </div>

          <div className="mt-6 text-sm opacity-80">
            <p>Serving Woodmead and nearby:&nbsp;
              <Link href="/carpenter-hyde-park" className="underline hover:text-amber-200">
              Hyde Park
              </Link>{" | "}
              <Link href="/carpenter-sunninghill" className="underline hover:text-amber-200">
              Sunninghill
              </Link>{" | "}
